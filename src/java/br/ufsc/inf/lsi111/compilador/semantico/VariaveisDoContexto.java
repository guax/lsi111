...
public class VariaveisDoContexto {
	...
	/**
	 * Armazena as informacoes sobre as dimensoes do vetor.
	 */
	private int nrDimensoes = 0;

	private Dimensoes dimensao1 = new Dimensoes();

	private Dimensoes dimensao2 = new Dimensoes();

	public int getNrDimensoes() {
		return nrDimensoes;
	}

	public void setNrDimensoes(int nrDimensoes) {
		this.nrDimensoes = nrDimensoes;
	}

	public Dimensoes getDimensao1() {
		return dimensao1;
	}

	public void setDimensao1(Dimensoes dimensao1) {
		this.dimensao1 = dimensao1;
	}

	public Dimensoes getDimensao2() {
		return dimensao2;
	}

	public void setDimensao2(Dimensoes dimensao2) {
